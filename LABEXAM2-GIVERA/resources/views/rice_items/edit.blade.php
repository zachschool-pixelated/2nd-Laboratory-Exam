        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('rice-items.update', $riceItem->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" id="price_per_kilogram" name="price_per_kilogram" 
                                value="{{ old('price_per_kilogram', $riceItem->price_per_kilogram) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                placeholder="Enter product description...">{{ old('description', $riceItem->description) }}</textarea>
                            @error('description')
                                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex gap-3 pt-4">
                            <button type="submit" class="btn-edit flex-1">
                                {{ __('Update Product') }}
                            </button>
